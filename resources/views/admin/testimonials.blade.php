        ...
        <div class="px-24 py-12">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5  md:p-6">
                <div class="flex rounded-xl">
                  <h1 class="font-bold text-lg">Reviews</h1>
                </div>
            
                <div class="mt-6 mb-6">
                    <a href="{{ route('admin.testimonial.create') }}" class="inline-flex justify-center mb-4 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium
                    ...
                    <table id="accountsTable" class="min-w-full pt-4 pb-6 divide-y divide-gray-200">
                        <thead class="bg-gray-200 text-gray-600 uppercase h-12 text-sm leading-normal">
                            <tr>
                                ...
                                <th class="px-6 py-3  text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Review</th>
                                <th class="px-6 py-3  text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Position/Address</th>
    ...
    $(document).ready(function () {
        $('#accountsTable').DataTable({
            ...
            columns: [
                ...
                { data: 'sub_details', name: 'sub_details' },
