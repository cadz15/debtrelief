 ...
 <header  class="header py-8 mb:py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-20">
    <div class="container mt-12 md:mt-1 px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
        <div class="mb-4 md:mb-16 lg:mt-20 xl:mt-30 xl:mr-12" data-aos="fade-right">
