        ...
        <div class="px-24 py-12">
            <div class="rounded-2xl w-1/2 border border-gray-200 bg-white p-5  md:p-6">
                <div class="flex rounded-xl">
                  <h1 class="font-bold text-lg">Update FAQ</h1>
                </div>
                ...
                <div class="mt-6 mb-6 flex gap-4 flex-col">
                    <form action="" method="POST" class="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            placeholder="Ex. What is Debt Relief?" value="{{ old('question', $faq->question) }}">
                            @error('question')
                        ...
                        <div>
                            ...
                            placeholder="Ex. Debt Relief is forgiving a portion of the debt, lowering the interest rate, stretching payments over a longer period, or consolidating multiple debts into a single, lower-interest one." >{{ old('answer', $faq->answer) }}</textarea>
                            @error('answer')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
