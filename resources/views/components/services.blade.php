    ...
    <div class="container my-24 mb-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2  gap-4">
            <div class="w-full flex flex-col py-12 gap-y-4 text-center justify-center items-center bg-gray rounded-lg" data-aos="zoom-in-up">
                <img class="w-20 h-20" src="https://www.svgrepo.com/show/514094/credit-card.svg" alt="alternative" />
            ...
            <div class="w-full flex flex-col py-12 gap-y-4 text-center justify-center items-center bg-gray rounded-lg" data-aos="zoom-in-up">
                <img class="w-20 h-20" src="https://www.svgrepo.com/show/438692/mortgage.svg" alt="alternative" />
                <h5>Mortgage Relief Options</h5>
                <p class="px-8">
