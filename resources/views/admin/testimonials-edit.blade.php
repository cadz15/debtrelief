        ...
        <div class="px-24 py-12">
            <div class="rounded-2xl w-1/2 border border-gray-200 bg-white p-5  md:p-6">
                <div class="flex rounded-xl">
                  <h1 class="font-bold text-lg">Edit Review</h1>
                </div>
                ...
                <div class="mt-6 mb-6 flex gap-4 flex-col">
                    <form action="" method="POST" class="flex flex-col gap-4" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            placeholder="Ex. James Smith" value="{{ old('name', $testimonial->name) }}">
                            @error('name')
                        ...
                        <div>
                            ...
                            placeholder="Ex. President" value="{{ old('sub_details', $testimonial->sub_details) }}">
                            @error('sub_details')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            placeholder="Ex. This site is awesome!" >{{ old('review', $testimonial->review) }}</textarea>
                            @error('review')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
